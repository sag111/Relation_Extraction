...
#path to trained model, replace this path with the model you need to download from
#https://huggingface.co/sagteam/pharm-relation-extraction/tree/main
export RE_MODEL_DIR="<Path to your model>"
#path to a file that contains class indices of the model and their names
export LABEL_MAP=$RE_MODEL_DIR/label_map.json
